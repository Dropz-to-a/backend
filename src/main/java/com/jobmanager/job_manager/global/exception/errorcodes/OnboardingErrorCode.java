...
public enum OnboardingErrorCode {
    ...
    USER_CANNOT_ONBOARD_COMPANY(
            HttpStatus.FORBIDDEN,
            "USER 계정은 회사 온보딩을 수행할 수 없습니다."
    ),

    COMPANY_CANNOT_ONBOARD_USER(
            HttpStatus.FORBIDDEN,
            "COMPANY 계정은 유저 온보딩을 수행할 수 없습니다."
    ),

    INVALID_ACCOUNT_TYPE(
            HttpStatus.FORBIDDEN,
            "해당 계정 타입에서는 온보딩을 수행할 수 없습니다."
    ),
